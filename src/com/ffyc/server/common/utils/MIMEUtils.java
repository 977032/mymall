...
public class MIMEUtils
{
    ...
    static
    {
        ...
        map.put("bmp", "application/x-MS-bmp");
        ...
        map.put("mpp", "application/vnd ms-appversion");
    ...
    public static String getMIME(String fileName)
    {
        ...
        return map.get(FilenameUtils.getExtension(fileName).toLowerCase());
    }
}
